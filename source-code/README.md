...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/CustomNavbarMenuItem
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/CustomNavbarMenuItem)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/CustomNavbarMenuItem`
* `site/tests/integration/Espo/Modules/CustomNavbarMenuItem`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/CustomNavbarMenuItem/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/CustomNavbarMenuItem/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/custom-navbar-menu-item/lib/init.js"
        ]
    }
    ```
